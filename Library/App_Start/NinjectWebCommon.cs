...
namespace Library.App_Start
{
    ...
    public static class NinjectWebCommon 
    {
        ...
        {
            var modules = new INinjectModule[] { new DALModule(), new BLLModule() };
        ...
        {
            //System.Web.Mvc.DependencyResolver.SetResolver(new Library.Util.NinjectDependencyResolver(kernel));
